      ...
      <div class="card">
        <div class="card-body pt-3">
          ...
          <ul class="nav nav-tabs nav-tabs-bordered">
            ...
            <li class="nav-item">
              <button onclick="set_tab(this.getAttribute('data-bs-target'))" class="nav-link active" data-bs-toggle="tab" data-bs-target="#profile-overview" id="profile-overview-tab">Slider One</button>
            </li>

            <li class="nav-item">
              <button onclick="set_tab(this.getAttribute('data-bs-target'))" class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-edit" id="profile-edit-tab">Slider Two</button>
            </li>

            <li class="nav-item">
              <button onclick="set_tab(this.getAttribute('data-bs-target'))" class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-settings" id="profile-settings-tab">Slider Three</button>
            </li>

            <li class="nav-item">
              <button onclick="set_tab(this.getAttribute('data-bs-target'))" class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-change-password" id="profile-change-password-tab">Slider Four</button>
            </li>
              ...
              <form method="post" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9"> 
                    ...
                    <div class="">
                      <img class="js-image-preview" src="<?=get_image($rows[0]->image ?? '')?>" alt="Profile" style="min-width:100%; height: 400px;object-fit: cover;">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <input name="title" type="text" class="form-control" id="title" value="<?=set_value('title',$rows[0]->title ?? '')?>" required>
                  </div>
                ...
                <div class="text-center">
                  ...
                  <button type="button" onclick="save_slider(event, 2)" type="submit" class="btn btn-danger float-end">Save Changes</button>
                </div>
              </form>
