            ...
            <ul class="footer-links footer-blog-entry list-unstyled">
              <li>
                <a href="single-post.html" class="d-flex align-items-center">
                  <img src="<?=ROOT?>/assets/images/post-sq-1.jpg" alt="" class="img-fluid me-3">
                  <div>
              ...
              <li>
                <a href="single-post.html" class="d-flex align-items-center">
                  <img src="<?=ROOT?>/assets/images/post-sq-2.jpg" alt="" class="img-fluid me-3">
                  <div>
                    <div class="post-meta d-block"><span class="date">Culture</span> <span class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
              ...
              <li>
                <a href="single-post.html" class="d-flex align-items-center">
                  <img src="<?=ROOT?>/assets/images/post-sq-3.jpg" alt="" class="img-fluid me-3">
                  <div>
                    <div class="post-meta d-block"><span class="date">Culture</span> <span class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
              ...
              <li>
                <a href="single-post.html" class="d-flex align-items-center">
                  <img src="<?=ROOT?>/assets/images/post-sq-4.jpg" alt="" class="img-fluid me-3">
                  <div>
                    <div class="post-meta d-block"><span class="date">Culture</span> <span class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
